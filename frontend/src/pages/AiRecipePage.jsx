...
import { useAuth } from "../context/AuthContext"; // ✅ חדש
import Navbar from "../components/Navbar";         // ✅ חדש
import GuestNavbar from "../components/GuestNavbar"; // ✅ חדש
...
export default function AiRecipePage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setError(
        "נראה שהשף שלנו הסתבך במטבח... נסו להזין 3 רכיבים בעברית, לדוגמה: ביצה, גבינה, מלפפון"
      );
    }
    setLoading(false);
  };
    ...
    <>
      ...
      <div className="ai-recipe-page">
        ...
        {error && (
          ...
          >
            <img
              src="https://media.giphy.com/media/3ohs4BSacFKI7A717q/giphy.gif"
              alt="שף מבולבל"
              className="chef-gif"
            />
            <p>{error}</p>
